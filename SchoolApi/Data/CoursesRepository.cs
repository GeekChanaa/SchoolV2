...
{
    public class CoursesRepository : IItemsRepository<Course,CourseParams>
    {
        private readonly SchoolDataContext _context;
        public CoursesRepository(SchoolDataContext context)
        {
            _context = context;
        }

        // Getting PagedList of Cities
        public async Task<PagedList<Course>> Get(CourseParams cityParams)
        {
            var cities = _context.Course.AsQueryable();
            ...
            return await PagedList<Course>.CreateAsync(cities, cityParams.PageNumber, cityParams.PageSize);
        }
    }
